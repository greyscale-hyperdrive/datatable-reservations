...
mariadbInterface.grabTimeSlotId = (restaurant_id, date, time, cb) => {
  ...
  connection.query(q, [restaurant_id, date, time], function(error, results, fields) {
    if (error) {
      throw error;
    }
    cb(error, results);
...
mariadbInterface.grabTimeSlots = (restaurant_id, date, cb) => {
  ...
  connection.query(q, [restaurant_id, date], function(error, results, fields) {
    if (error) {
      throw error;
    }
    cb(error, results); 
...
mariadbInterface.updateTimeSlot = (restaurant_id, new_date, old_date, new_time, old_time, cb) => {
  ...
  connection.query(q, [new_date, new_time, restaurant_id, old_date, old_time], function(error, results, fields) {
    if (error) {
      throw error;
    }
    cb(error, results);
